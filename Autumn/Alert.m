...
- (void) loadWindow {
    ...
    [box setFillColor: [NSColor colorWithCalibratedWhite:0.0 alpha:0.75]];
    [box setBorderColor: [NSColor colorWithCalibratedWhite:1.0 alpha:1.0]];
    [box setBorderWidth: 1.0];
    [box setCornerRadius: 27.0];
